      ...
      <RequireAuth>
        <div className="mb-2 mt-4">
          ...
          >
            ...
            <option value="electronicStudio">Electronic Studio Design</option>
            <option value="mechanicalStudio">Mechanical Studio</option>
            <option value="fabricationStudio">Precision Fabrication</option>
            <option value="manufacturingStudio">
              Advanced Manufacturing Studio
            </option>
            <option value="robotics&Drone">Robotics and Drone Studio</option>
          </select>
        </div>
